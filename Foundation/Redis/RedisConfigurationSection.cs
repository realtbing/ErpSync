...
namespace Foundation.Redis
{
    public class RedisConfigurationSection : ConfigurationSection
    {
        ...
        {
            return (RedisConfigurationSection)ConfigurationManager.GetSection("redis");
        }

        /// <summary>
        /// 可写的Redis链接地址
        /// </summary>
        [ConfigurationProperty("WriteServerList", Required = false)]
        ...
        public int DefaultDb
        {
            get
            {
                var defaultDb = (int)base["DefaultDb"];
                return defaultDb > 0 ? defaultDb : 0;
            }
            set
            {
