...
namespace Logic.Wechat
{
    ...
    public class WxPayData
    {
        ...
        #region
        ///// <summary>
        ///// 将Dictionary转成xml throws WxPayException
        ///// </summary>
        ...
        ///// <returns> 经转换得到的Dictionary WxPayException</returns>
        //public SortedDictionary<string, object> FromXml(string xml,bool checkSign = true)
        //{
        ...
        //    return m_values;
        //}
        //public SortedDictionary<string, object> FormartXml(string xml)
        //{
        //    if (string.IsNullOrEmpty(xml))
        //    {
        //        throw new WxPayException("将空的xml串转换为WxPayData不合法!");
        ...
        ///// <returns>return 签名, sign字段不参加签名</returns>
